      ...
      <section id="pricing" className="mx-auto max-w-7xl scroll-mt-20 px-6 py-28">
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-zinc-400">
              Pay once for a mock interview and your first reports — or go
              monthly for ongoing analysis and mentoring sessions.
            </p>
          </div>
        </Reveal>
          ...
          <Reveal delay={100}>
            <div className="flex h-full flex-col rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-8">
              ...
              <p className="mt-4 text-4xl font-bold tracking-tight text-zinc-50">
                {formatINR(2000)}
                <span className="text-lg font-medium text-zinc-400"> once</span>
              </p>
              ...
              <ul className="mt-8 flex flex-1 flex-col gap-3 text-sm text-zinc-400">
                {[
                  ...
                  "1 Product Mentor assessment",
                  "1 mock interview with a real TPM, scheduled within a week",
                  "Full report & roadmap access",
                ].map((item) => (
          ...
          <Reveal delay={200}>
            ...
            >
              ...
              <div className="relative">
                ...
                <ul className="mt-8 flex flex-1 flex-col gap-3 text-sm text-zinc-400">
                  {[
                    "Regular resume analysis & assessments",
                    "2 × 1-hour sessions with your mentor every month",
                    "Full report & roadmap access",
                    "Cancel anytime",
                  ].map((item) => (
                    <li key={item} className="flex items-center gap-2">
        ...
        <Reveal delay={300}>
          <div className="mx-auto mt-8 flex max-w-4xl flex-col items-start justify-between gap-6 rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-8 sm:flex-row sm:items-center">
            <div className="flex items-start gap-4">
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-indigo-600/20">
              ...
              <div>
                ...
                <p className="mt-1.5 max-w-xl text-sm leading-relaxed text-zinc-400">
                  Team workshops, interview-panel practice, and TPM upskilling
